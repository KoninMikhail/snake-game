import LogoImageSrc from 'static/images/Identity/Logo.png';
import { CustomImage } from '../../../atoms/images/CustomImage/CustomImage';
 ...
 * @return {JSX.Element}
 */
export const LogoImage = (props: ILogoImageProps) => (
